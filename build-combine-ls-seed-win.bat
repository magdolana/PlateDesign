...
set LS_SEED_EXE_PATH=%CUR_DIR%\release\LS-seed.exe
...
echo.
copy /b /y %NWEXE_PATH% %LS_SEED_EXE_PATH%
cd buildTools\ar
if exist %ICO_PATH% Resourcer -op:upd -src:%LS_SEED_EXE_PATH% -type:14 -name:IDR_MAINFRAME -file:%ICO_PATH%
copy /b /y %LS_SEED_EXE_PATH% + %NWZIP_PATH% %LS_SEED_EXE_PATH%
cd ..\..
